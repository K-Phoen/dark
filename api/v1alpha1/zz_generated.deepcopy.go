...
func (in *AlertManagerSpec) DeepCopyInto(out *AlertManagerSpec) {
	*out = *in
	if in.DefaultGroupBy != nil {
		in, out := &in.DefaultGroupBy, &out.DefaultGroupBy
	...
	if in.MessageTemplates != nil {
		in, out := &in.MessageTemplates, &out.MessageTemplates
...
func (in *ContactPointType) DeepCopyInto(out *ContactPointType) {
	*out = *in
	...
	if in.Opsgenie != nil {
		...
		*out = new(OpsgenieContactType)
		(*in).DeepCopyInto(*out)
	}
	if in.Discord != nil {
		in, out := &in.Discord, &out.Discord
		*out = new(DiscordContactType)
		(*in).DeepCopyInto(*out)
	}
}
