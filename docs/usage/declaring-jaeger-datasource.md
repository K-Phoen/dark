# Declaring a Jaeger data source

A Jaeger data source allows the integration of [Jaeger](https://www.jaegertracing.io/) into Grafana.

## Example usage

The following example will create a `my-jaeger` data source in Grafana:
...
spec:
  jaeger:
    ...
    # URL of the Jaeger server.
    # Required.
    url: "http://jaeger-server:16686"
    ...
    # Enable basic authentication to the Jaeger server.
    # Optional. Default: none
    basic_auth:
      username:
